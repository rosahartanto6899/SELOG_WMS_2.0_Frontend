...
const SvgMultiRouteEndWhiteIcon = ({
  title,
  titleId,
  ...props
  ...
  >
    ...
    <g filter="url(#multi-route-end-white-icon_svg__a)">
      <path
      ...
      />
      <path
        d="m15.885 25.656.686-.513.687.513a.859.859 0 0 1-1.373 0Z"
        fill="#3A8DDB"
      />
      <path
        fillRule="evenodd"
    ...
    <defs>
      <filter
        id="multi-route-end-white-icon_svg__a"
        x={0}
        y={0}
        width={33.143}
        height={40}
...
export default SvgMultiRouteEndWhiteIcon;
