...
import { OutgoingReportRow } from "@sera-types/outgoing-report.type";
...
export const SearchByOptions = () => {
  const { t } = useTranslation(undefined, {
    keyPrefix: "report.outgoingReport.table.options",
  });
...
export const Columns = () => {
  const { t } = useTranslation(undefined, {
    keyPrefix: "report.outgoingReport.table",
  });
  ...
  return [
    {
      ...
      render: (_: never, record: OutgoingReportRow) => record.no,
      fixed: leftFixed,
      exception: true,
      width: 60,
    },
