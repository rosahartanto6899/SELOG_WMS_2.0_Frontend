...
interface Props {
  ...
  options?: any;
  loading: any;
  onFetch: typeof materialActions.getMaterialsFetch;
  onDelete: typeof materialActions.deleteMaterialFetch;
}
...
const MaterialTable = (props: Props) => {
  ...
  const baseLink = "/master-data/material";
