...
interface CustomerFiltersProps {
  data: CustomerRouteParams;
  onChangeFilter: (_payload: CustomerRouteParams) => void;
...
const CustomerRouteFilters = ({
  ...
  const { t } = useTranslation(undefined, {
    keyPrefix: "customerRoute.table.filter",
  });

  const { isApiResponse, sendErrorHandlerApi, sendErrorHandler } =
    useErrorHandler("/pages/sales-management/customer-route/filter");

  const IS_LOADING = loading[customerRouteTypes.GET_CUSTOMER_ROUTES];
