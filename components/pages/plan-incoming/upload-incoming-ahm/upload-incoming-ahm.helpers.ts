...
export const COLUMN_LABELS: Record<string, string> = {
  ...
  deliveryNoteStatus: "Delivery Note Status",
  deliveryNoteType: "Delivery Note Type",
  planReceiveMinDate: "Plan Receive Min Date",
  planReceiveMinTime: "Plan Receive Min Time",
  planReceiveMaxDate: "Plan Receive Max Date",
  planReceiveMaxTime: "Plan Receive Max Time",
  plantId: "Plant ID",
  ...
  partNumberDesc: "Part Number Desc",
