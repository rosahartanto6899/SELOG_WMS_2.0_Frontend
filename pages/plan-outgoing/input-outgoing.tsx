 ...
 *  ?id= → mode edit; submit/cancel kembali (Outstanding Outgoing belum ada →
 *  dashboard dulu, ganti backUrl saat halaman list dibuat). */
const InputOutgoingPage = () => {
  ...
  const back = () => router.push(ROUTE.DASHBOARD);
