...
interface DashboardDailyShipmentMonitoringProps {
  paramPowerBI?: PowerBIParams | null;
}

const DashboardDailyShipmentMonitoringPage = ({
  paramPowerBI,
}: Readonly<DashboardDailyShipmentMonitoringProps>) => {
  const { t } = useTranslation(undefined, {
    keyPrefix: "dashboard.dailyShipmentMonitoring",
  });
...
export async function getServerSideProps() {
  ...
  const pageId = decryptData(
    process.env.POWER_BI_PAGE_ID_DAILY_SHIPMENT_MONITORING as string,
  );
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(DashboardDailyShipmentMonitoringPage);
