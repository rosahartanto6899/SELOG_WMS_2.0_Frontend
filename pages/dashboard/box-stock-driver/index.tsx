...
interface DashboardStockBoxDriverProps {
  paramPowerBI?: PowerBIParams | null;
}

const DashboardStockBoxDriverPage = ({
  paramPowerBI,
}: Readonly<DashboardStockBoxDriverProps>) => {
  const { t } = useTranslation(undefined, {
    keyPrefix: "dashboard.stockBoxDriver",
  });
...
export async function getServerSideProps() {
  ...
  const pageId = decryptData(
    process.env.POWER_BI_PAGE_ID_STOCK_BOX_DRIVER as string,
  );
