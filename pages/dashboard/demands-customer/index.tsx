...
interface DashboardDemandCustomerProps {
  paramPowerBI?: PowerBIParams | null;
}

const DashboardDemandCustomerPage = ({
  paramPowerBI,
}: Readonly<DashboardDemandCustomerProps>) => {
  const { t } = useTranslation(undefined, {
    keyPrefix: "dashboard.demandCustomer",
  });
...
export async function getServerSideProps() {
  ...
  const pageId = decryptData(
    process.env.POWER_BI_PAGE_ID_DEMANDS_CUSTOMER as string,
  );
