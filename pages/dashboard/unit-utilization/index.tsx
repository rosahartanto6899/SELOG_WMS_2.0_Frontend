...
interface DashboardUnitUtilizationProps {
  paramPowerBI?: PowerBIParams | null;
}

const DashboardUnitUtilizationPage = ({
  paramPowerBI,
}: Readonly<DashboardUnitUtilizationProps>) => {
  const { t } = useTranslation(undefined, {
    keyPrefix: "dashboard.unitUtilization",
  });
...
export async function getServerSideProps() {
  ...
  const pageId = decryptData(
    process.env.POWER_BI_PAGE_ID_UNIT_UTILIZATION as string,
  );
