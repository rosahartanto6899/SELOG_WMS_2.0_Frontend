...
interface DashboardRevenueRecognitionProps {
  paramPowerBI?: PowerBIParams | null;
}

const DashboardRevenueRecognitionPage = ({
  paramPowerBI,
}: Readonly<DashboardRevenueRecognitionProps>) => {
  const { t } = useTranslation(undefined, {
    keyPrefix: "dashboard.revenueRecognition",
  });
...
export async function getServerSideProps() {
  ...
  const pageId = decryptData(
    process.env.POWER_BI_PAGE_ID_REVENUE_RECOGNITION as string,
  );
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(DashboardRevenueRecognitionPage);
