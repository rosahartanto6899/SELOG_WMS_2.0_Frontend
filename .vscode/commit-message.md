...
- **Example**: For branch `feature/LOGIS-1234-lorem-ipsum`, use `tkt:LOGIS-1234`
- **Example**: For branch `bugfix/LOGIS-5678-lorem-ipsum`, use `tkt:LOGIS-5678`
...
```
ver:1.0.0 tkt:LOGIS-1234 msg:Add JWT authentication middleware
